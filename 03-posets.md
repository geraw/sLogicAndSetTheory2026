...
**פתרון:**
1. **רפלקסיביות:** לכל $(a,b)$, מתקיים $a=a$ ו-$b \le b$, לכן $(a,b) \le_{lex} (a,b)$.
   **אנטי-סימטריות:** נניח $(a,b) \le_{lex} (c,d)$ ו-$(c,d) \le_{lex} (a,b)$.
   אם $a < c$ אז לא ייתכן $(c,d) \le_{lex} (a,b)$ (כי נדרש $c \le a$). לכן $a=c$.
   כעת, מההגדרה נשאר $b \le d$ ו-$d \le b$, ולכן $b=d$. סה"כ $(a,b)=(c,d)$.
   **טרנזיטיביות:** נניח $(a,b) \le (c,d)$ ו-$(c,d) \le (e,f)$.
   - אם $a < c$ או $c < e$, אז $a < e$ ולכן $(a,b) \le (e,f)$.
   - אחרת $a=c=e$, ואז $b \le d$ ו-$d \le f \implies b \le f$, ולכן $(a,b) \le (e,f)$.
...
$(a,b) \le_{prod} (c,d)$ אם $a \le c$ וגם $b \le d$.
...
**פתרון:**
האיברים ב-$A$ הם: $(1,1), (1,2), (2,1), (2,2)$.

- **מינימום:** $(1,1)$. לכל $(x,y) \in A$, מתקיים $1 \le x$ ו-$1 \le y$, לכן $(1,1) \le_{prod} (x,y)$.
  לכן הוא גם **מזערי יחיד**.

- **מקסימום:** $(2,2)$. לכל $(x,y) \in A$, מתקיים $x \le 2$ ו-$y \le 2$, לכן $(x,y) \le_{prod} (2,2)$.
  לכן הוא גם **מירבי יחיד**.

שימו לב: בניגוד לסדר הלקסיקוגרפי, כאן $(1,2)$ ו-$(2,1)$ **אינם ניתנים להשוואה** (כי $1 \le 2$ אבל $2 \not\le 1$). לכן זהו **אינו** סדר קווי.

</v-click>

---

# תרגיל 3: אנטי-שרשראות בקבוצת החזקה
...
# תרגיל 5: השוואת גדלים של קבוצות
