...
<div style="display: flex; justify-content: center;">
  <img src="./images/infinity_and_beyond_math.png" alt="Math Image" style="width: 150px;"/>
</div>

---
section: יחס סדר בין קבוצות
---

# סדר בין קבוצות
 
- נתחיל עם הסימון הבא לשתי קבוצות $A$ ו-$B$:
...
- $\sim$ הוא יחס סדר מעל $\mathcal{P}(A)$ עבור כל קבוצה $A$.
