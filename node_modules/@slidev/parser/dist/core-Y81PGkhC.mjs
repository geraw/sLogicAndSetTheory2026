import { parseAspectRatio } from "./utils-CLLoIRbA.mjs";
...
//#endregion
export { detectFeatures, getDefaultConfig, parse, parseSlide, parseSync, prettify, prettifySlide, resolveConfig, resolveFonts, stringify, stringifySlide, verifyConfig };