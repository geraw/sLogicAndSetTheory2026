...
- מציאת דרך טובה להוכחת טענה כוללת, כלומר טענה מהצורה $\forall x (\alpha)$ עשויה להיות משימה קשה.
...
- **דוגמה:** הוכחת הטענה "לכל מספר טבעי $n$, אם הוא מתחלק ב-4, אז הוא מתחלק גם ב-2".
  - **הוכחה:** 
    - ניקח $n$ מספר טבעי כלשהו.
    - נניח כי $n$ מתחלק ב-4. כלומר, קיים $k \in \mathbb{N}$ כך ש-$n=4k$.
    - מכאן, $n=2(2k)$, ולכן $n$ מתחלק ב-2.
    - מכיוון ש-$n$ היה מספר טבעי כלשהו, הוכחנו כי הטענה נכונה לכל מספר טבעי $n$.
...
<img class="absolute top-3/5 left-1/2 -translate-x-1/2 -translate-y-1/2 w-170 h-90" src="/images/הוכחה בשלילה.png" />
...
- נכתוב את $r$ כשבר מצומצם: $r = \frac{p}{q}$, כאשר $p, q$ הם מספרים שלמים ללא גורם משותף גדול מ-1.
...
<img class="absolute top-7.7/10 left-3/20 -translate-x-1/2 -translate-y-1/2 w-60 h-50" src="/images/sqrt_2.png" />